...
public class insertnewresult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
          ...
          if(rs.next()){
              st.executeUpdate("insert into results (rollno,phy,chemistry,maths,em,dbms)values('"+rollno+"','"+phy+"','"+chemistry+"','"+maths+"','"+em+"','"+dbms+"')");
               JOptionPane.showMessageDialog(null,"Successfully added the data" );
               setVisible(false );
               new insertnewresult().setVisible(true);
          }
          else{
              JOptionPane.showMessageDialog(null,"Roll no doesnt exists" );
          }
